...
import jp.mercator.memolistapplication.ui.MainActivity
...
class AlarmBroadcastReceiver():BroadcastReceiver(){
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        val desc=intent?.getStringExtra(jp.mercator.memolistapplication.AlarmBroadcastReceiver.Companion.KEY_DESCRIPTION)
       val pending=PendingIntent.getActivity(context, requestCode,afterNotifyIntent,PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        nm?.notify(jp.mercator.memolistapplication.R.string.app_name,notification)
    }
}