...
import jp.mercator.memolistapplication.databinding.ActivityCreateMemoBinding
import com.google.android.material.dialog.MaterialAlertDialogBuilder
import jp.mercator.memolistapplication.model.memo.Contents
import jp.mercator.memolistapplication.room.Memo
import jp.mercator.memolistapplication.viewmodel.CreateMemoViewModel
import java.util.*
...
class CreateMemoActivity : AppCompatActivity() {
    ...
    fun setAlarm(calendar: Calendar?) {
        calendar ?: return
        val intent = Intent(applicationContext, jp.mercator.memolistapplication.AlarmBroadcastReceiver::class.java)
        intent.putExtra(jp.mercator.memolistapplication.AlarmBroadcastReceiver.KEY_DESCRIPTION, memo.description)
